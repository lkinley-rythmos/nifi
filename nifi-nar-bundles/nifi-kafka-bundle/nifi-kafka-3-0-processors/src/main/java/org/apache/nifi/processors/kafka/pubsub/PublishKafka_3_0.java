...
@Tags({"Apache", "Kafka", "Put", "Send", "Message", "PubSub", "3.0"})
@CapabilityDescription("Sends the contents of a FlowFile as a message to Apache Kafka using the Kafka 3.0 Producer API."
    + "The messages to send may be individual FlowFiles or may be delimited, using a "
    + "user-specified delimiter, such as a new-line. "
    + "The complementary NiFi processor for fetching messages is ConsumeKafka_3_0.")
...
@WritesAttribute(attribute = "msg.count", description = "The number of messages that were sent to Kafka for this FlowFile. This attribute is added only to "
    ...
    + "be greater than 1.")
public class PublishKafka_3_0 extends AbstractProcessor implements VerifiableProcessor {
