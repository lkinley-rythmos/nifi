...
@CapabilityDescription("Provides a service to write records to a Kafka 3.0+ topic.")
public class KafkaRecordSink_3_0 extends AbstractControllerService implements RecordSinkService {
        ...
        for (PropertyDescriptor propertyDescriptor : context.getProperties().keySet()) {
            ...
            if (propertyValue != null) {
                ...
                if (propertyName.endsWith(".ms") && !StringUtils.isNumeric(propertyValue.trim())) { // kafka standard time notation
                    propertyValue = String.valueOf(FormatUtils.getPreciseTimeDuration(propertyValue.trim(), TimeUnit.MILLISECONDS));
                }
