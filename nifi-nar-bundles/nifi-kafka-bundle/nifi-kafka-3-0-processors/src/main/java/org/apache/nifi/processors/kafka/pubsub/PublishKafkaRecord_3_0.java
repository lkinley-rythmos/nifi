...
@Tags({"Apache", "Kafka", "Record", "csv", "json", "avro", "logs", "Put", "Send", "Message", "PubSub", "3.0"})
@CapabilityDescription("Sends the contents of a FlowFile as individual records to Apache Kafka using the Kafka 3.0 Producer API. "
    + "The contents of the FlowFile are expected to be record-oriented data that can be read by the configured Record Reader. "
    + "The complementary NiFi processor for fetching messages is ConsumeKafkaRecord_3_0.")
...
@SeeAlso({PublishKafka_3_0.class, ConsumeKafka_3_0.class, ConsumeKafkaRecord_3_0.class})
public class PublishKafkaRecord_3_0 extends AbstractProcessor implements VerifiableProcessor {
